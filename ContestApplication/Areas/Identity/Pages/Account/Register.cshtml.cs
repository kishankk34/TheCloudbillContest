...
namespace ContestApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<ContestApplicationUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ContestApplicationUser { UserName = Input.Email, Email = Input.Email,
                                            FirstName = Input.FirstName, LastName = Input.LastName, 
                                            CollegeName = Input.CollegeName, ApplicantType = Input.ApplicantType };
